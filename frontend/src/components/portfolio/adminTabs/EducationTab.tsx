...
import type {EducationCreateRequest, EducationStatus} from "../../../type/portfolio/education.ts";
...
export const EducationTab = () => {
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        const request: EducationCreateRequest = {
            ...
            endDate: formData.endDate !== null ? parseYearMonthString(formData.endDate) : null,
